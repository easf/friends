...
CREATE TABLE IF NOT EXISTS `friendsdb`.`profile` (
  ...
  `browser_language` VARCHAR(64) NULL,
  `browser_country` VARCHAR(64) NULL,
  `survey_language` VARCHAR(64) NULL,
...
-- -----------------------------------------------------
-- Table `friendsdb`.`relationship_from_survey`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendsdb`.`relationship_from_survey` ;
...
CREATE TABLE IF NOT EXISTS `friendsdb`.`relationship_from_survey` (
  ...
  `description` VARCHAR(128) NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_relationship_from_survey_user1_idx` (`user_idhash` ASC),
  INDEX `fk_relationship_from_survey_user2_idx` (`user_idhash1` ASC),
  CONSTRAINT `fk_relationship_from_survey_user1`
    FOREIGN KEY (`user_idhash`)
    REFERENCES `friendsdb`.`user` (`idhash`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_relationship_from_survey_user2`
    FOREIGN KEY (`user_idhash1`)
    REFERENCES `friendsdb`.`user` (`idhash`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `friendsdb`.`gender_from_survey`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `friendsdb`.`trait`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendsdb`.`trait` ;
...
CREATE TABLE IF NOT EXISTS `friendsdb`.`trait` (
  ...
  INDEX `fk_traits_user2_idx` (`user_idhash1` ASC),
  CONSTRAINT `fk_traits_user1`
    FOREIGN KEY (`user_idhash`)
    REFERENCES `friendsdb`.`user` (`idhash`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_traits_user2`
    FOREIGN KEY (`user_idhash1`)
    REFERENCES `friendsdb`.`user` (`idhash`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
