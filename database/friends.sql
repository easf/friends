...
CREATE TABLE IF NOT EXISTS `friendsdb`.`reaction` (
  ...
  INDEX `fk_reaction_comment1_idx` (`comment_id` ASC),
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `fk_reaction_comment1`
    ...
    REFERENCES `friendsdb`.`comment` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `friendsdb`.`tag` (
  ...
  INDEX `fk_tag_comment1_idx` (`comment_id` ASC),
...
CREATE TABLE IF NOT EXISTS `friendsdb`.`comment_has_comment` (
  ...
  PRIMARY KEY (`comment_id`, `comment_id1`),
  INDEX `fk_comment_has_comment_comment2_idx` (`comment_id1` ASC),
  INDEX `fk_comment_has_comment_comment1_idx` (`comment_id` ASC),
